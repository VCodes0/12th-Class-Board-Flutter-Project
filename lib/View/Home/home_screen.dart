      ...
      body: Container(
        ...
        child: Stack(
          children: [
            ...
            // This Positioned widget now contains a SingleChildScrollView
            Positioned(
              top: mq.height * 0.38,
              left: 0,
              right: 0,
              bottom: 0, // This defines the available vertical space
              child: Padding(
                ...
                child: SingleChildScrollView(
                  // <--- KEY CHANGE: Added SingleChildScrollView
                  child: Column(
                    children: [
                      InkWell(
                        onTap: () {
                      ...
                      const SizedBox(
                        height: 20,
                      ), // Added some bottom padding to prevent items from touching the bottom edge when scrolled
                    ],
                  ),
                ),
              ),
